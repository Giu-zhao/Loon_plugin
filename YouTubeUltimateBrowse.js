/* YouTube Ultimate Loon - browse/search/guide response cleaner */
(function () {
  "use strict";
  ...
  try {
    ...
    if (optionEnabled("debug", false)) {
      console.log("[YouTube Ultimate][browse] removed=" + stats.removed);
    }
    ...
    if (optionEnabled("debug", false)) {
      console.log("[YouTube Ultimate][browse] fail-open=invalid-response");
    }
    return $done({});
  }
})();
